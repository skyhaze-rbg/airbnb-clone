  ...
  return (
    <div className="container mx-auto">
      <div className="property-image">
        <Image
          src={"/properties/" + propertyData.image}
          alt="Property Image"
          width={1500}
          height={800}
        ></Image>
        ...
        <div>
          <div className="request-to-book">
            ...
            <div className="row">
              <div className="left">
                Dates:{" "}
                <span id="booking-dates">
                  {checkInDate} to {checkOutDate}
                </span>
              </div>
              <div className="right">
                <a href="#" id="edit-dates" onClick={handleEditDates}>
                  Edit
                </a>
              </div>
            </div>
            <div className="row">
              ...
              <div className="right">
                <a href="#" id="edit-guests" onClick={handleEditGuests}>
                  Edit
                </a>
              </div>
            </div>
          ...
          <form className="payment-form" onSubmit={handleFormSubmit}>
            ...
            <div className="row">
              <p>
                Free cancellation for 48 hours. Cancel before 29 May for a
                partial refund. <a href="#">Learn more</a>
              </p>
            </div>
            <hr />
            <div className="row">
              <button
                id="request-to-book"
                type="submit"
                className="bg-[#ff5a5f] text-white border-0 rounded p-[10px_20px] text-base cursor-pointer hover:bg-[#e6555a]"
              >
                Request to book
              </button>
            </div>
